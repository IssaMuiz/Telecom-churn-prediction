...
- Feature engineering in progress to create new features based on insights from error analysis. Initial features include:
  ...
  - statsmodels analysis was performed to identify statistically significant features. Based on the odd ratio and p-values, features such as 'Contract_Two year', 'InternetService_Fiber optic', and 'PaymentMethod_Electronic check' were found to be significant predictors of churn. These insights will guide further feature engineering and model refinement.
