...
def test_change_to_numeric(raw_data):
    ...
    assert cleaned_data.loc[0, "TotalCharges"] == 1200.0
    assert cleaned_data.loc[1, "TotalCharges"] == 3400.0
    assert cleaned_data.loc[2, "TotalCharges"] == 2300.0
    assert cleaned_data.loc[3, "TotalCharges"] == 2300.0
