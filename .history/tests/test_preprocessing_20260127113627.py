...
import pandas as pd
import numpy as np
from src.data_exploratory.clean_data import drop_unused_columns, replace_empty_string, drop_duplicated_rows, check_missing_values
import pytest
...
def test_drop_unused_columns(raw_data):
    ...
    assert "Country" and "ID" not in cleaned_data.columns
