...
- Error analysis conducted to identify misclassification patterns and what was discovered was that among the false negatives (churners predicted as non-churners), a significant portion had high tenure and low monthly charges, indicating that long-term customers with lower bills were being overlooked by the model. Conversely, false positives (non-churners predicted as churners) often exhibited moderate tenure but higher monthly charges, suggesting that customers with mid-level engagement but higher costs were being misclassified.
